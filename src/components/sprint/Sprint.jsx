...
function Sprint() {
  ...
  return (
    <div className="relative p-6 bg-gray-50 dark:bg-gray-900 min-h-screen ml-16 overflow-auto md:ml-16 lg:ml-20 pt-20">
      <h1 className="text-4xl font-bold mb-8 text-center text-gray-800 dark:text-gray-100">Sprint Management</h1>
      ...
      <div className="mt-10 space-y-6">
        ...
        {sprints.length > 0 ? (
          ...
          <p className="text-center text-gray-600 dark:text-gray-400">No sprints available</p>
        )}
      </div>
