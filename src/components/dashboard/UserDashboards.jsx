...
export const UserDashboards = ({ dashboardName, dashboardType, projectName, url }) => {
    ...
    return (
        <>
            <div className='w-full h-auto hover:scale-[1.02] transition duriration-200 px-5 py-6 bg-slate-100 shadow-lg rounded-xl flex flex-row justify-between items-center'>
                <div className=''>
