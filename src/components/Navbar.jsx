        ...
        <header className="text-gray-600 bg-[#2A085F] body-font">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                    ...
                    <span className="text-white ml-3 font-bold text-3xl">Click Up</span>
                </a>
                <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
                    <Link to="/" className="mr-5 font-semibold duration-300 text-white hover:text-gray-300">Home</Link>
                    <Link to="" className="mr-5 font-semibold duration-300 text-white hover:text-gray-300">About Us</Link>
                    <Link to="" className="mr-5 font-semibold duration-300 text-white hover:text-gray-300">Contact Us</Link>
